...
class PeoplesController: UITableViewController, NSFetchedResultsControllerDelegate, UISearchBarDelegate {
...
//    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let descriptionController = segue.destination as? PeopleDescriptionController {
